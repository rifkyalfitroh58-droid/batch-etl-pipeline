...
```bash
git clone https://github.com/rifkyalfitroh58-droid/batch-etl-pipeline.git
...
**Nama Kamu**
- GitHub: [rifkyalfitroh58-droid](https://github.com/rifkyalfitroh58-droid)
- LinkedIn: [linkedin.com/in/Rifky Alfitroh](https://linkedin.com/in/Rifky Alfitroh)
